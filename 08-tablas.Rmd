...
Por lo tanto, `column_spec(column = 1, bold = (parques_resumen$anio == 2021))` va a hacer que las tres últimas filass de la columna uno estén en negrita, y las demás no.
Luego, `collapse_rows()` colapsa las filas según el año y entonces esas tres últimas filas se transforman en una.

En este caso el órden de las operaciones es importantes. 
