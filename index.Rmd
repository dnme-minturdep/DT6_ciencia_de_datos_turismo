...
En este documento técnico realizaremos una introducción al concepto de ciencia de datos y otros conceptos relacionados (como aprendizaje automático e inteligencia artificial), el proceso de la ciencia de datos y el lenguaje de programación R como la caja de herramientas princiaples para poder llevar adelante cada tarea y etapa de este proceso.

El documento se divide en xx capítulos, el primero es más teórico-conceptual y los demás presentan ejemplos prácticos y ejercicios para introducir y practicar los conceptos mencionados.
