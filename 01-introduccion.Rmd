...
Este formato pensado para el análisis tiene la característica que, en los set de datos ordenados, *cada columna es una variable y cada fila una observación*.
