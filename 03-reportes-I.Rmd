...
Un archivo de rmarkdown (generalmente con la extensión `.Rmd`), a diferencia de un script `.R`, es un archivo de texto plano que combina código de R que genera resultados (gráficos, tablas, etc...) y el texto que lo describe.
...
El encabezado es una serie de líneas puestas entre tres guiones (`---`) que determinan las propiedades globales del documento, como el título, el formato de salida, información de autoría, etc... También ahí se pueden cambiar opciones del formato de salida, como el estilo de la tabla de contenidos.
...
Cualquier resultado del código (gráficos, tablas, texto, etc...) será insertado en el documento
